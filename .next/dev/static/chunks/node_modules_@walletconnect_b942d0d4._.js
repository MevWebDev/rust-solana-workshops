...
function Me(t) {
    return t != null && typeof t != "function" && Le(t.length);
}
function ze(t) {
    return t === "__proto__";
}
...
function y(t, e, s, i = new Map, r = void 0) {
    ...
    if (t instanceof DataView) {
        ...
        return i.set(t, n), f(n, t, s, i, r), n;
    }
    ...
    if (t instanceof Error) {
        ...
        return i.set(t, n), n.message = t.message, n.name = t.name, n.stack = t.stack, n.cause = t.cause, f(n, t, s, i, r), n;
    }
    if (t instanceof Boolean) {
        const n = new Boolean(t.valueOf());
        return i.set(t, n), f(n, t, s, i, r), n;
    }
    if (t instanceof Number) {
        const n = new Number(t.valueOf());
        return i.set(t, n), f(n, t, s, i, r), n;
    }
    if (t instanceof String) {
        const n = new String(t.valueOf());
        return i.set(t, n), f(n, t, s, i, r), n;
    }
    if (typeof t == "object" && ct(t)) {
        const n = Object.create(Object.getPrototypeOf(t));
        return i.set(t, n), f(n, t, s, i, r), n;
    }
    return t;
}
function f(t, e, s = t, i, r) {
    const a = [
        ...Object.keys(e),
        ...ie(e)
    ];
...
function ot(t, e) {
    return at(t, (s, i, r, a)=>{
        ...
        if (typeof t == "object") {
            if (F(t) === oe && typeof t.constructor != "function") {
                const c = {};
                return a.set(t, c), f(c, t, r, a), c;
            }
            switch(Object.prototype.toString.call(t)){
                ...
                case ce:
                    {
                        const c = {};
                        return f(c, t), c.length = t.length, c[Symbol.iterator] = t[Symbol.iterator], c;
                    }
                default:
                    return;
            }
...
function pe(t) {
    return t !== null && typeof t == "object" && F(t) === "[object Arguments]";
}
function H(t) {
...
function lt(t) {
    if (x(t)) return t;
    if (Array.isArray(t) || U(t) || t instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && t instanceof SharedArrayBuffer) return t.slice(0);
    ...
    if (t instanceof Error) {
        let i;
        return t instanceof AggregateError ? i = new s(t.errors, t.message, {
            cause: t.cause
        }) : i = new s(t.message, {
            cause: t.cause
        }), i.stack = t.stack, Object.assign(i, t), i;
    }
...
function $(t, e, s, i) {
    ...
    for(let a = 0; a < r.length; a++){
        ...
        if (pe(c) && (c = {
            ...
            ...o
        }), typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"] < "u" && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].isBuffer(c) && (c = he(c)), Array.isArray(c)) if (Array.isArray(o)) {
        ...
        p !== void 0 ? t[n] = p : Array.isArray(c) || H(o) && H(c) && (L(o) || L(c) || B(o) || B(c)) ? t[n] = $(o, c, s, i) : o == null && L(c) ? t[n] = $({}, c, s, i) : o == null && B(c) ? t[n] = he(c) : (o === void 0 || c !== void 0) && (t[n] = c);
    }
    return t;
}
function dt(t, ...e) {
...
const le = "error", ft = "wss://relay.walletconnect.org", mt = "wc", ue = "universal_provider", A = `${mt}@2:${ue}:`, de = "https://rpc.walletconnect.org/v1/", fe = "generic", gt = `${de}bundler`, w = "call_status", yt = 86400, M = {
    DEFAULT_CHAIN_CHANGED: "default_chain_changed"
};
var wt = Object.defineProperty, vt = Object.defineProperties, Pt = Object.getOwnPropertyDescriptors, me = Object.getOwnPropertySymbols, bt = Object.prototype.hasOwnProperty, Ot = Object.prototype.propertyIsEnumerable, ge = (t, e, s)=>e in t ? wt(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s, E = (t, e)=>{
    for(var s in e || (e = {}))bt.call(e, s) && ge(t, s, e[s]);
    if (me) for (var s of me(e))Ot.call(e, s) && ge(t, s, e[s]);
    return t;
}, It = (t, e)=>vt(t, Pt(e));
function ye(t, e, s) {
    var i;
    ...
    return ((i = e.rpcMap) == null ? void 0 : i[r.reference]) || `${de}?chainId=${r.namespace}:${r.reference}&projectId=${s}`;
}
function St(t) {
...
function Pe(t) {
    ...
    for (const [c, o] of Object.entries(t)){
        const p = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCaipNamespace"])(c) ? [
            c
        ] : o.chains, l = o.methods || [], h = o.events || [], m = o.rpcMap || {}, u = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(c);
        n[u] = It(E(E({}, n[u]), o), {
        ...
        }), ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidObject"])(m) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidObject"])(((r = n[u]) == null ? void 0 : r.rpcMap) || {})) && (n[u].rpcMap = E(E({}, m), (a = n[u]) == null ? void 0 : a.rpcMap));
    }
    return n;
}
function be(t) {
...
function Oe(t) {
    ...
    for (const [s, i] of Object.entries(t)){
        const r = i.methods || [], a = i.events || [], n = i.accounts || [], c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCaipNamespace"])(s) ? [
            s
        ] : i.chains ? i.chains : we(i.accounts);
        e[s] = {
            chains: c,
            methods: r,
            events: a,
...
const Ie = {}, v = (t)=>Ie[t], G = (t, e)=>{
    Ie[t] = e;
};
var Et = Object.defineProperty, Se = Object.getOwnPropertySymbols, Nt = Object.prototype.hasOwnProperty, jt = Object.prototype.propertyIsEnumerable, $e = (t, e, s)=>e in t ? Et(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s, Ae = (t, e)=>{
    for(var s in e || (e = {}))Nt.call(e, s) && $e(t, s, e[s]);
    if (Se) for (var s of Se(e))jt.call(e, s) && $e(t, s, e[s]);
    return t;
};
const Ee = "eip155", Ct = [
    "atomic",
    ...
    "sessionKeys",
    "auxiliaryFunds"
], _t = (t)=>t && t.startsWith("0x") ? BigInt(t).toString(10) : t, W = (t)=>t && t.startsWith("0x") ? t : `0x${BigInt(t).toString(16)}`, Ne = (t)=>Object.keys(t).filter((e)=>Ct.includes(e)).reduce((e, s)=>(e[s] = Dt(t[s]), e), {}), Dt = (t)=>typeof t == "string" && At(t) ? JSON.parse(t) : t, qt = (t, e, s)=>{
    ...
    for (const c of s){
        ...
        if (p) {
            const l = p?.[`${Ee}:${o}:${e}`];
            a[W(o)] = Ae(Ae({}, a[W(o)]), Ne(l || p));
        }
    }
    for (const [c, o] of Object.entries(a))Object.keys(o).length === 0 && delete a[c];
    return Object.keys(a).length > 0 ? a : void 0;
};
var Rt = Object.defineProperty, xt = (t, e, s)=>e in t ? Rt(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s, Ft = (t, e, s)=>xt(t, typeof e != "symbol" ? e + "" : e, s);
let J;
class Q {
    constructor(e){
        Ft(this, "storage"), this.storage = e;
    }
    async getItem(e) {
    ...
    static getStorage(e) {
        return J || (J = new Q(e)), J;
    }
}
var Ut = Object.defineProperty, Ht = Object.defineProperties, Bt = Object.getOwnPropertyDescriptors, je = Object.getOwnPropertySymbols, Lt = Object.prototype.hasOwnProperty, Mt = Object.prototype.propertyIsEnumerable, Ce = (t, e, s)=>e in t ? Ut(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s, zt = (t, e)=>{
    for(var s in e || (e = {}))Lt.call(e, s) && Ce(t, s, e[s]);
    if (je) for (var s of je(e))Mt.call(e, s) && Ce(t, s, e[s]);
    return t;
}, Gt = (t, e)=>Ht(t, Bt(e));
async function Wt(t, e) {
    const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseChainId"])(t.result.capabilities.caip345.caip2), i = t.result.capabilities.caip345.transactionHashes, r = await Promise.allSettled(i.map((h)=>Jt(s.reference, h, e))), a = r.filter((h)=>h.status === "fulfilled").map((h)=>h.value).filter((h)=>h);
...
async function Kt({ sendCalls: t, storage: e }) {
    const s = await e.getItem(w);
    await e.setItem(w, Gt(zt({}, s), {
        [t.result.id]: {
            request: t.request,
            result: t.result,
            expiry: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcExpiry"])(yt)
        }
    }));
}
async function Vt({ resultId: t, storage: e }) {
    const s = await e.getItem(w);
    if (s) {
...
async function Yt({ resultId: t, storage: e }) {
...
var Xt = Object.defineProperty, Qt = Object.defineProperties, Zt = Object.getOwnPropertyDescriptors, _e = Object.getOwnPropertySymbols, kt = Object.prototype.hasOwnProperty, Tt = Object.prototype.propertyIsEnumerable, K = (t, e, s)=>e in t ? Xt(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s, V = (t, e)=>{
    for(var s in e || (e = {}))kt.call(e, s) && K(t, s, e[s]);
    if (_e) for (var s of _e(e))Tt.call(e, s) && K(t, s, e[s]);
    return t;
}, Y = (t, e)=>Qt(t, Zt(e)), g = (t, e, s)=>K(t, typeof e != "symbol" ? e + "" : e, s);
class es {
    constructor(e){
    ...
    setDefaultChain(e, s) {
        ...
        this.chainId = parseInt(e), this.events.emit(M.DEFAULT_CHAIN_CHANGED, {
    ...
    getHttpProvider(e) {
        ...
        return this.httpProviders[s] || (this.httpProviders = Y(V({}, this.httpProviders), {
    ...
    async getCapabilities(e) {
        ...
        const p = this.client.session.get(e.topic), l = ((n = p?.sessionProperties) == null ? void 0 : n.capabilities) || {}, h = o.length > 0 ? o.join(",") : `0x${this.chainId.toString(16)}`, m = `${c}${h}`, u = l?.[m];
        if (u) return u;
        let _;
        try {
            _ = qt(p, c, o);
        ...
        if (_) return _;
        const Z = await this.client.request(e);
        try {
            await this.client.session.update(e.topic, {
                sessionProperties: Y(V({}, p.sessionProperties || {}), {
                    capabilities: Y(V({}, l || {}), {
                        [m]: Z
                    })
                })
    ...
    async getCallStatus(e) {
        ...
        if (o) try {
            return await Wt(o, this.getHttpProvider.bind(this));
        } catch (p) {
    ...
    getBundlerUrl(e, s) {
        return `${gt}?projectId=${this.client.core.projectId}&chainId=${e}&bundler=${s}`;
    }
    async sendCalls(e) {
        var s, i, r;
        ...
        return !c || !p || !(l != null && l.length) || await Kt({
            sendCalls: {
                request: n,
                result: a
            },
...
var ts = Object.defineProperty, ss = (t, e, s)=>e in t ? ts(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s, P = (t, e, s)=>ss(t, typeof e != "symbol" ? e + "" : e, s);
class is {
    constructor(e){
        P(this, "name", fe), P(this, "client"), P(this, "httpProviders"), P(this, "events"), P(this, "namespace"), P(this, "chainId"), this.namespace = e.namespace, this.events = v("events"), this.client = v("client"), this.chainId = this.getDefaultChain(), this.name = this.getNamespaceName(), this.httpProviders = this.createHttpProviders();
    }
    updateNamespace(e) {
    ...
    setDefaultChain(e, s) {
        ...
        const i = this.chainId;
        this.chainId = e, this.events.emit(M.DEFAULT_CHAIN_CHANGED, {
            currentCaipChainId: `${this.name}:${e}`,
            previousCaipChainId: `${this.name}:${i}`
        });
    }
    ...
    createHttpProvider(e, s) {
        const i = s || ye(e, this.namespace, this.client.core.projectId);
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$provider$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JsonRpcProvider"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$http$2d$connection$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](i, v("disableProviderPing")));
    }
}
var ns = Object.defineProperty, rs = Object.defineProperties, as = Object.getOwnPropertyDescriptors, De = Object.getOwnPropertySymbols, cs = Object.prototype.hasOwnProperty, os = Object.prototype.propertyIsEnumerable, X = (t, e, s)=>e in t ? ns(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s, S = (t, e)=>{
    for(var s in e || (e = {}))cs.call(e, s) && X(t, s, e[s]);
    if (De) for (var s of De(e))os.call(e, s) && X(t, s, e[s]);
    return t;
}, j = (t, e)=>rs(t, as(e)), d = (t, e, s)=>X(t, typeof e != "symbol" ? e + "" : e, s);
class C {
    constructor(e){
        ...
        this.providerOpts = e, this.logger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createLogger"])({
            logger: (s = e.logger) != null ? s : le,
            name: (i = this.providerOpts.name) != null ? i : ue
    ...
    async authenticate(e, s) {
        ...
        if (this.session = a.session, this.session) {
            const n = Oe(this.session.namespaces);
            this.namespaces = N(this.namespaces, n), await this.persist("namespaces", this.namespaces), this.onConnect();
        }
        return a;
    }
    on(e, s) {
    ...
    async pair(e) {
        ...
        const n = await a();
        this.session = n;
        const c = Oe(n.namespaces);
        return this.namespaces = N(this.namespaces, c), await this.persist("namespaces", this.namespaces), await this.persist("optionalNamespaces", this.optionalNamespaces), this.onConnect(), this.session;
    }
    setDefaultChain(e, s) {
        try {
            if (!this.session) return;
            const [i, r] = this.validateChain(e), a = this.getProvider(i);
    ...
    async createClient() {
        ...
        if (this.client = this.providerOpts.client || await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SignClient"].init({
            ...
            logger: this.providerOpts.logger || le,
            relayUrl: this.providerOpts.relayUrl || ft,
    ...
    createProviders() {
        ...
        G("client", this.client), G("events", this.events), G("disableProviderPing", this.disableProviderPing), e.forEach((s)=>{
            if (!this.session) return;
            const i = $t(s, this.session);
            if (i?.length === 0) return;
            const r = we(i), a = N(this.namespaces, this.optionalNamespaces), n = j(S({}, a[s]), {
                accounts: i,
                chains: r
            });
            switch(s){
                case "eip155":
                    this.rpcProviders[s] = new es({
                        namespace: n
                    });
                    break;
                default:
                    this.rpcProviders[s] = new is({
                        namespace: n
                    });
            }
        });
    ...
    registerEventListeners() {
        ...
        this.client.on("session_ping", (e)=>{
            ...
            if (a.name === "accountsChanged") {
                const n = a.data;
                n && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidArray"])(n) && this.events.emit("accountsChanged", n.map(be));
            } else if (a.name === "chainChanged") {
                const n = i.chainId, c = i.event.data, o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(n), p = z(n) !== z(c) ? `${o}:${z(c)}` : n;
                this.onChainChanged({
    ...
    getProvider(e) {
        return this.rpcProviders[e] || this.rpcProviders[fe];
    }
    onSessionUpdate() {
    ...
    setNamespaces(e) {
        ...
        this.optionalNamespaces = N(s, i), this.sessionProperties = r, this.scopedProperties = a;
    }
    validateChain(e) {
        const [s, i] = e?.split(":") || [
            "",
    ...
    emitAccountsChangedOnChainChange({ namespace: e, currentCaipChainId: s, previousCaipChainId: i }) {
        ...
        try {
            ...
            if (!n) return;
            const c = n.filter((o)=>o.includes(`${s}:`)).map(be);
...
//# sourceMappingURL=node_modules_%40walletconnect_b942d0d4._.js.map